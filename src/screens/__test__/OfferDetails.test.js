...
describe('OfferDetails component', () => {
  ...
  it('renders correctly', () => {
    ...
    const component = (
      <OfferDetails route={{params: {offer}}}/>
    );
    ...
    const terms = screen.queryAllByText('Terms: Offer valid only on purchases made through our');
    expect(terms.length).toBe(1);

    const button = screen.getByText('Claim Offer');
